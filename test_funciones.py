...
#para probar check_char para todo el rango de a-Z, se debe utilizar la parametrizacion
...
#para probar caps_switch para todo el rango de a-Z, se debe utilizar la parametrizacion
#se utilizan las listas creadas en la parametrizacion anterior

#se define la lista vacia que contiene los parametros
param2= []

#se crean las tuplas con la letra en mayuscula y minuscula y vice versa ((a,A),(A,a))
